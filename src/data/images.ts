export const images = {
  ...
  safety:
    'https://images.unsplash.com/photo-1581093458791-9d42cc7fcbc2?auto=format&fit=crop&w=1600&q=85',
  boomLift:
    'https://images.unsplash.com/photo-1590496793929-36417d3117de?auto=format&fit=crop&w=1400&q=85',
  telescopic:
    'https://images.unsplash.com/photo-1517581177682-a085bb7ffb15?auto=format&fit=crop&w=1400&q=85',
  cherryPicker:
    'https://images.unsplash.com/photo-1523848309072-c199db53f137?auto=format&fit=crop&w=1400&q=85',
  spiderLift:
    'https://images.unsplash.com/photo-1565008447742-97f6f38c985c?auto=format&fit=crop&w=1400&q=85',
  skylift:
    'https://images.unsplash.com/photo-1485083269755-a7b559a4fe5e?auto=format&fit=crop&w=1400&q=85',
  scissorLift:
  ...
  engineer:
    'https://images.unsplash.com/photo-1581092334651-ddf26d9a09d0?auto=format&fit=crop&w=1200&q=85',
  projects: [
  ...
  gallery: [
    ...
    'https://images.unsplash.com/photo-1581093458791-9d42cc7fcbc2?auto=format&fit=crop&w=1200&q=85',
  ...
  clients: [
    'https://dummyimage.com/240x96/ffffff/0F4C81&text=InfraCore',
    'https://dummyimage.com/240x96/ffffff/0F4C81&text=MetroBuild',
    'https://dummyimage.com/240x96/ffffff/0F4C81&text=SteelWorks',
    'https://dummyimage.com/240x96/ffffff/0F4C81&text=Prime+Logistics',
    'https://dummyimage.com/240x96/ffffff/0F4C81&text=UrbanGrid',
  ],
  people: [
